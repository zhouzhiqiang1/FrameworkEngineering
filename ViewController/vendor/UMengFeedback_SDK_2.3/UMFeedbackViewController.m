...
@interface UMFeedbackViewController () <UITableViewDataSource, UITableViewDelegate, UMFeedbackDataDelegate, UINavigationBarDelegate, UIAlertViewDelegate, RecorderDelegate, UIGestureRecognizerDelegate, UIImagePickerControllerDelegate, UIWebViewDelegate>
...
- (void)playRecordButtonAnimationAction:(NSTimer *)timer {
    NSString *imageName = [NSString stringWithFormat:@"umeng_fb_audio_play_%02d", self.playRecordButtonAnimationIndex % 3 + 1];
